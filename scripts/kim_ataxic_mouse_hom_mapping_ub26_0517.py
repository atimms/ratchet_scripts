...
##working dir
working_dir = '/data/atimms/kim_ataxic_mouse_0517'
fastq_dir = '/data/atimms/kim_ataxic_mouse_0517'
...
##files etc
fq_dict = {'F60': ['F60_1.fq.gz', 'F60_2.fq.gz'], 'M55': ['M55_USD16081822_HGCKYALXX_L4_1.fq.gz', 'M55_USD16081822_HGCKYALXX_L4_2.fq.gz'], 
		'M75': ['M75_USD16081823_HJW2VALXX_L7_1.fq.gz', 'M75_USD16081823_HJW2VALXX_L7_2.fq.gz'], 
		'M77': ['M77_USD16081824_HJW2VALXX_L7_1.fq.gz', 'M77_USD16081824_HJW2VALXX_L7_2.fq.gz']}
post_bwa_bam = '.bwa.bam'
sorted_bam = '.bwa_sorted.bam'
mkdup_bam = '.bwa_mkdup.bam'
bamslist_file = 'bams.list'
st_vcf = 'kim_ataxic_mouse_0517.vcf.gz'
st_avinputs = ['F60.avinput', 'M55.avinput', 'M75.avinput', 'M77.avinput']
...
av_protocol = ['-protocol', 'refGene,rmsk,genomicSuperDups,snp142,generic,generic,generic,generic,generic', '-genericdbfile', 'F60.avinput,M55.avinput,M75.avinput,M77.avinput,mgp.v5.merged.snps_all.dbSNP142.avinput']
...
def multianno_to_annotated(avinputs): 
	head = ['Chr', 'Start', 'End', 'Ref', 'Alt', 'Func.refGene', 'Gene.refGene', 'GeneDetail.refGene', 'ExonicFunc.refGene', 'AAChange.refGene', 'rmsk', 'genomicSuperDups', 'snp142','F60', 'M55', 'M75', 'M77', 'mgp.v5.snps', 'Zygosity', 'Qual', 'Coverage', 'Chr', 'Pos', 'Filter', 'Ref2', 'Alt2','Qual', 'Filter', 'GT_info', 'Format', 'Info']
...
##combine fqs
##used cat to combine fastq files for F60
...
for sample in affected_samples:
	...
	##keep if het in parents
	filtering_annotated.filter(working_dir, "and", sample + "_2.temp", sample + "_3.temp", [14,15], ['==','=='], ['het','het'])
	##keep if hom
...
for sample in affected_samples:
	##auts2
	filtering_annotated.filter(working_dir, "and", sample + '.annotated.txt' , sample + "_1.temp", [1, 2,3], ['==','>=', '<='], ['chr5',131437306, 132542649])
	##keep if het in all sample
	filtering_annotated.filter(working_dir, "and", sample + "_1.temp", sample + ".auts2_het_in_all.xls", [14,15,16,17], ['==','==','==','=='], ['het','het','het','het'])
# '''

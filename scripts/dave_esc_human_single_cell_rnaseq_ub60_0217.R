...
workingDir = "/data/atimms/dave_esc_0117/single_cell_esc_0117";
setwd(workingDir);

##read in count and metadata
countData1 <- read.csv('GSE75748_bulk_cell_type_ec.csv', header=T, row.names=1)
colData1 <- read.table('GSE75748_bulk_cell_type_ec_metadata.txt', header=T, row.names=1)
head(countData1)
head(colData1)

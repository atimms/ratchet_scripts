...
def combine_or_rename_all_fq_files(sample_dict, fq_suffices):
	for sample in sample_dict:
		r1_fq = sample + fq_suffices[0]
		r2_fq = sample + fq_suffices[1]
		r1_files = sample_dict[sample][0]
		r2_files = sample_dict[sample][1]
		combine_fqs(r1_files, r1_fq)
		combine_fqs(r2_files, r2_fq)
...
working_dir = '/data/atimms/kim_rnaseq_somatic_vars_0417'
os.chdir(working_dir)
project_name = 'somatic_vars'
sample_fq_dict = {'H26362_EGL':[['H26362-EGL1-tube9.r1.fq.gz','H26362_GrB-1_ATGTCA_L001_R1_001.fastq.gz'],['H26362-EGL1-tube9.r2.fq.gz','H26362_GrB-1_ATGTCA_L001_R2_001.fastq.gz']],
		'H26362_PK': [['H26362-PK1-1-tube6.r1.fq.gz','H26362_PkA-1_CCGTCC_L001_R1_001.fastq.gz'], ['H26362-PK1-1-tube6.r2.fq.gz','H26362_PkA-1_CCGTCC_L001_R2_001.fastq.gz']], 
		'H26362_Whole': [['H26362-Wver-tube10.r1.fq.gz'],['H26362-Wver-tube10.r2.fq.gz']], 
		'H26362_RL': [['H26362-RL-tube7.r1.fq.gz','H26362-VZ-tube8.r1.fq.gz'],['H26362-RL-tube7.r2.fq.gz','H26362-VZ-tube8.r2.fq.gz']],
		'H26566_EGL': [['H26566-EGL1-tube26.r1.fq.gz', 'H26566-EGL2-tube27.r1.fq.gz'], ['H26566-EGL1-tube26.r2.fq.gz','H26566-EGL2-tube27.r2.fq.gz']], 
		'H26566_PK': [['H26566-PK1-1rep-tube23.r1.fq.gz','H26566-PK1-1-tube22.r1.fq.gz'],['H26566-PK1-1rep-tube23.r2.fq.gz','H26566-PK1-1-tube22.r2.fq.gz']], 
		'H26566_Whole': [['H26566-Wver-tube28.r1.fq.gz'], ['H26566-Wver-tube28.r2.fq.gz']],
		'H26566_RL': [['H26566-RL-tube24.r1.fq.gz','H26566-VZ-tube25.r1.fq.gz'],['H26566-RL-tube24.r2.fq.gz','H26566-VZ-tube25.r2.fq.gz']],
		'H26857_EGL': [['H26857-EGL1-tube13.r1.fq.gz'],['H26857-EGL1-tube13.r2.fq.gz']], 
		'H26857_PK': [['H26857-PK1-1-tube11.r1.fq.gz'],['H26857-PK1-1-tube11.r2.fq.gz']],
		'H26857_Whole': [['H26857-Whm-tube17.r1.fq.gz','H26857-Wver-tube15.r1.fq.gz'],['H26857-Whm-tube17.r2.fq.gz','H26857-Wver-tube15.r2.fq.gz']],
		'H26857_RL': [['H26857-RL-tube14.r1.fq.gz', 'H26857-VZ-tube16.r1.fq.gz'],['H26857-RL-tube14.r2.fq.gz', 'H26857-VZ-tube16.r2.fq.gz']]}
sample_names = sample_fq_dict.keys()
samples = ['H26362', 'H26566', 'H26857']
tissue_names = ['EGL', 'PK', 'RL', 'Whole']
new_fq_suffixes = ['_r1.fastq.gz', '_r2.fastq.gz']
##combine fq files, and and proccess bam files
# combine_or_rename_all_fq_files(sample_fq_dict, new_fq_suffixes)
# star_align_paired_end_2_pass(sample_names, star_index_dir, threads, new_fq_suffixes)
# proccess_bam_files(sample_names)
##variant calling
...
for sample in samples:
	...
	for tissue in tissue_names:
		vcf = 'somatic_vars_pisces/' + sample + '_' + tissue + '.star.gatk.vcf'

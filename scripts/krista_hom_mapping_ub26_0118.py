...
working_dir = '/data/atimms/krista_0118'
fastq_dir = '/data/atimms/krista_0118'
...
##files etc
fq_dict = {'K50000022':['K50000022.r1.fq.gz', 'K50000022.r2.fq.gz'], 
		'K50000024':['K50000024.r1.fq.gz', 'K50000024.r2.fq.gz'],
		'K50000095':['K50000095.r1.fq.gz', 'K50000095.r2.fq.gz'],
		'combined':['combined.r1.fq.gz', 'combined.r2.fq.gz']}

post_bwa_bam = '.bwa.bam'
sorted_bam = '.bwa_sorted.bam'
mkdup_bam = '.bwa_mkdup.bam'
bamslist_file = 'bams.list'
st_vcf = 'krista_0118.vcf.gz'
...
##combine fqs
'''
samples = ['K50000022', 'K50000024', 'K50000095']
for s in samples:
	combine_fq_file(glob.glob(s + '*_1.fq.gz'), glob.glob(s + '*_2.fq.gz'), s + '.r1.fq.gz', s + '.r2.fq.gz')
##then combine into single file
combine_fq_file(glob.glob('*.r1.fq.gz'), glob.glob('*.r2.fq.gz'), 'combined.r1.fq.gz', 'combined.r2.fq.gz')
'''

...
DimPlot(object = hm.integrated, pt.size = 0.1)
dev.copy2pdf(file="./signac_analysis/human_scatac_0420.harmony.UMAP_by_cluster.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/human_scatac_0420.harmony.feature_plot1.res0.8.pdf", width=20)

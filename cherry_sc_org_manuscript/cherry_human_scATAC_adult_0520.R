...
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu5.qc.pdf", width=20)
FragmentHistogram(object = Hu5, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu5.frag_by_ns.pdf", width=20)
TSSPlot(Hu5, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu5.tss_enrichment.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu5.UMAP.pdf", width=20)
##save file
saveRDS(Hu5_subset, file = "./signac_analysis/adult/Hu5_subset.rds")
...
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu7.qc.pdf", width=20)
FragmentHistogram(object = Hu7, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu7.frag_by_ns.pdf", width=20)
TSSPlot(Hu7, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu7.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
...
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu7.UMAP.pdf", width=20)
##save file
saveRDS(Hu7_subset, file = "./signac_analysis/adult/Hu7_subset.rds")
...
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu8.qc.pdf", width=20)
FragmentHistogram(object = Hu8, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu8.frag_by_ns.pdf", width=20)
TSSPlot(Hu8, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu8.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
...
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.Hu8.UMAP.pdf", width=20)
##save file
saveRDS(Hu8_subset, file = "./signac_analysis/adult/Hu8_subset.rds")
...
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.merged.UMAP_by_cluster.pdf", width=20)
DimPlot(combined, split.by = 'dataset', pt.size = 0.1, label = TRUE)
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.merged.UMAP_split_by_sample.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.harmony_res0.8.UMAP_by_cluster.pdf", width=20)
DimPlot(hm.integrated, split.by = 'dataset', pt.size = 0.1, label = TRUE)
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.harmony_res0.8.UMAP_split_by_sample.pdf", width=20)
##res 0.4
...
##save/load data
#saveRDS(peaks.use, file = "./signac_analysis/adult/peaks.use.rds")
#saveRDS(anchors, file = "./signac_analysis/adult/anchors.rds")
#saveRDS(combined_split, file = "./signac_analysis/adult/combined_split.rds")
combined_split <- readRDS(file = "./signac_analysis/adult/combined_split.rds")
anchors <- readRDS(file = "./signac_analysis/adult/anchors.rds")
peaks.use <- readRDS(file = "./signac_analysis/adult/peaks.use.rds")
...
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.integrated.UMAP_by_sample.pdf", width=20)
...
DimPlot(object = integrated, pt.size = 0.1, label = T)
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.integrated.UMAP_by_cluster.res0.4.pdf", width=20)
DimPlot(integrated, split.by = 'dataset', pt.size = 0.1, label = T)
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.integrated.UMAP_by_sample.res0.4.pdf", width=20)
integrated <- FindClusters(object = integrated, verbose = FALSE, algorithm = 3, resolution = 0.8)
DimPlot(object = integrated, pt.size = 0.1, label = T)
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.integrated.UMAP_by_cluster.res0.8.pdf", width=20)
DimPlot(integrated, split.by = 'dataset', pt.size = 0.1, label = T)
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.integrated.UMAP_by_sample.res0.8.pdf", width=20)


##save/load integrated data
saveRDS(integrated, file = "./signac_analysis/adult/integrated.rds")
#integrated <- readRDS(file = "./signac_analysis/adult/integrated.rds")
...
dev.copy2pdf(file="./signac_analysis/adult/human_scatac_adult_0520.integrated.feature_plot1.res0.4.pdf", width=20)

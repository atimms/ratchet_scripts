...
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.qc.pdf", width=20)
...
#Filter the data
human <- subset(human, subset = nFeature_RNA > 200 & nFeature_RNA < 6000 & percent.mt < 5)
...
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.pca.pdf", width=20)
ElbowPlot(human, ndims=30)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.elbow_plot.pdf", width=20)
...
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.UMAP.res0.8.sample_split.pdf", width = 20)
DimPlot(human_merged, reduction='umap', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.UMAP.res0.8.pdf", width=20)
...
write.csv(counts_cluster_sample, file='./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.counts_cluster_sample.res0.8.csv')
...
write.csv(human_merged.markers, file='./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.markers.res0.8.csv')
...
#Plot UMAP
DimPlot(human_merged, reduction='umap', split.by='sample', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.UMAP.res0.4.sample_split.pdf", width = 20)
DimPlot(human_merged, reduction='umap', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.UMAP.res0.4.pdf", width=20)
#Identify the number of cells in each cluster between samples
counts_cluster_sample = table(human_merged$seurat_clusters, human_merged$sample)
write.csv(counts_cluster_sample, file='./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.counts_cluster_sample.res0.4.csv')
#Find all markers that define each cluster
human_merged.markers <- FindAllMarkers(human_merged, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
write.csv(human_merged.markers, file='./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.markers.res0.4.csv')
...
#Plot UMAP
DimPlot(human_merged, reduction='umap', split.by='sample', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.UMAP.dim20_res0.4.sample_split.pdf", width = 20)
DimPlot(human_merged, reduction='umap', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.UMAP.dim20_res0.4.pdf", width=20)
#Identify the number of cells in each cluster between samples
counts_cluster_sample = table(human_merged$seurat_clusters, human_merged$sample)
write.csv(counts_cluster_sample, file='./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.counts_cluster_sample.dim20_res0.4.csv')
#Find all markers that define each cluster
human_merged.markers <- FindAllMarkers(human_merged, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
write.csv(human_merged.markers, file='./seurat_analysis/adult/human_scrnaseq_adult_0520.merged.markers.dim20_res0.4.csv')

#Save object
saveRDS(human_merged, file = "./seurat_analysis/adult/human_merged.rds")
...
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.harmony.harmony_plot.pdf", width = 20)
...
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.harmony.UMAP.res0.8.sample_split.pdf", width = 20)
DimPlot(human_harmony, reduction='umap', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.harmony.UMAP.res0.8.pdf", width=20)
#Identify the number of cells in each cluster between samples
counts_cluster_sample = table(human_harmony$seurat_clusters, human_harmony$sample)
write.csv(counts_cluster_sample, file='./seurat_analysis/adult/human_scrnaseq_adult_0520.harmony.counts_cluster_sample.res0.8.csv')
#Find all markers that define each cluster
human_harmony.markers <- FindAllMarkers(human_harmony, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
write.csv(human_harmony.markers, file='./seurat_analysis/adult/human_scrnaseq_adult_0520.harmony.markers.res0.8.csv')

##change resolutions - 0.4
human_harmony <- FindClusters(human_harmony, resolution = 0.4)
#Plot UMAP
DimPlot(human_harmony, reduction='umap', split.by='sample', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.harmony.UMAP.res0.4.sample_split.pdf", width = 20)
DimPlot(human_harmony, reduction='umap', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_adult_0520.harmony.UMAP.res0.4.pdf", width=20)
#Identify the number of cells in each cluster between samples
counts_cluster_sample = table(human_harmony$seurat_clusters, human_harmony$sample)
write.csv(counts_cluster_sample, file='./seurat_analysis/adult/human_scrnaseq_adult_0520.harmony.counts_cluster_sample.res0.4.csv')
#Find all markers that define each cluster
human_harmony.markers <- FindAllMarkers(human_harmony, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
write.csv(human_harmony.markers, file='./seurat_analysis/adult/human_scrnaseq_adult_0520.harmony.markers.res0.4.csv')
...
human.list <- SplitObject(human, split.by = 'sample')
...
##change resolution
human_integrated <- FindClusters(human_integrated, assay = 'integrated', resolution = 0.8)

#Plot UMAP
DimPlot(human_integrated, reduction='umap', split.by='sample', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_0520.integrated.UMAP_res0.8.sample_split.pdf", width = 20)
DimPlot(human_integrated, reduction='umap', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_0520.integrated.UMAP_res0.8.pdf", width=20)
...
write.csv(counts_cluster_sample, file='./seurat_analysis/adult/human_scrnaseq_0520.integrated.counts_cluster_sample.res0.8.csv')
...
write.csv(human_integrated_SCT.markers, file='./seurat_analysis/adult/human_scrnaseq_0520.integrated.markers.res0.8.csv')

##change resolution
human_integrated <- FindClusters(human_integrated, assay = 'integrated', resolution = 0.4)

#Plot UMAP
DimPlot(human_integrated, reduction='umap', split.by='sample', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_0520.integrated.UMAP_res0.4.sample_split.pdf", width = 20)
DimPlot(human_integrated, reduction='umap', pt.size=0.1, label = TRUE)
dev.copy2pdf(file="./seurat_analysis/adult/human_scrnaseq_0520.integrated.UMAP_res0.4.pdf", width=20)


#Identify the number of cells in each cluster between samples/time
counts_cluster_sample = table(human_integrated$seurat_clusters, human_integrated$sample)
write.csv(counts_cluster_sample, file='./seurat_analysis/adult/human_scrnaseq_0520.integrated.counts_cluster_sample.res0.4.csv')
...
#Find all markers that define each cluster
human_integrated_SCT.markers <- FindAllMarkers(human_integrated, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
write.csv(human_integrated_SCT.markers, file='./seurat_analysis/adult/human_scrnaseq_0520.integrated.markers.res0.4.csv')


#Save object to avoid needing to re-run previous computations
saveRDS(human_integrated, file = "./seurat_analysis/adult/human_integrated.rds")

...
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0620.Hu5.qc.pdf", width=20)
FragmentHistogram(object = Hu5, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0620.Hu5.frag_by_ns.pdf", width=20)
TSSPlot(Hu5, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0620.Hu5.tss_enrichment.pdf", width=20)
...
doublets_mask = read.table('./signac_analysis/scrublet_test/Hu5_scATAC_predicted_doublet_mask.txt')
Hu5$scrublet_doublet = unlist(doublets_mask)
head(Hu5[[]])
Hu5_subset = subset(Hu5, subset = scrublet_doublet == "False")
Hu5_subset <- subset(Hu5_subset, subset = peak_region_fragments > 2000 & peak_region_fragments < 30000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
Hu5
Hu5_subset
...
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0620.UMAP.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0620.Hu7.qc.pdf", width=20)
FragmentHistogram(object = Hu7, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0620.Hu7.frag_by_ns.pdf", width=20)
TSSPlot(Hu7, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0620.Hu7.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
doublets_mask = read.table('./signac_analysis/scrublet_test/Hu7_scATAC_predicted_doublet_mask.txt')
Hu7$scrublet_doublet = unlist(doublets_mask)
head(Hu7[[]])
Hu7_subset = subset(Hu7, subset = scrublet_doublet == "False")
...
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0620.Hu8.qc.pdf", width=20)
FragmentHistogram(object = Hu8, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0620.Hu8.frag_by_ns.pdf", width=20)
TSSPlot(Hu8, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0620.Hu8.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
doublets_mask = read.table('./signac_analysis/scrublet_test/Hu8_scATAC_predicted_doublet_mask.txt')
Hu8$scrublet_doublet = unlist(doublets_mask)
head(Hu8[[]])
Hu8_subset = subset(Hu8, subset = scrublet_doublet == "False")
...
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0520.merged.res_0.4.UMAP_by_cluster.pdf", width=20)
DimPlot(combined, split.by = 'dataset', pt.size = 0.1, label = TRUE)
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0520.merged.res_0.4.UMAP_split_by_sample.pdf", width=20)
...
saveRDS(Hu5_subset, file = "./signac_analysis/scrublet_test/Hu5_combPeaks.rds")
saveRDS(Hu7_subset, file = "./signac_analysis/scrublet_test/Hu7_combPeaks.rds")
saveRDS(Hu8_subset, file = "./signac_analysis/scrublet_test/Hu8_combPeaks.rds")
saveRDS(combined, file = "./signac_analysis/scrublet_test/combined.rds")
saveRDS(combined.peaks, file = "./signac_analysis/scrublet_test/combined_peaks.rds")


##run harmony

## load data if needed - from merged data
combined <- readRDS(file = "./signac_analysis/scrublet_test/combined.rds")
...
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0520.harmony_res0.4.UMAP_by_cluster.pdf", width=20)
DimPlot(hm.integrated, split.by = 'dataset', pt.size = 0.1, label = TRUE)
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0520.harmony_res0.4.UMAP_split_by_sample.pdf", width=20)

##save/load file
#saveRDS(hm.integrated, file = "./signac_analysis/scrublet_test/harmony_integrated.rds")
#hm.integrated <- readRDS(file = "./signac_analysis/scrublet_test/harmony_integrated.rds")
...
write.csv(harmony.markers, file='./signac_analysis/scrublet_test/human_scatac_adult_0520.harmony.marker.res0.4.csv')
head(harmony.markers)

## get genes closest to marker genes, row names are weird in a few places
##temp way to load results
#harmony.markers <- read.csv('./signac_analysis/scrublet_test/human_scatac_adult_0520.harmony.marker.res0.4.csv')
##list of peaks
...
closest_genes <- ClosestFeature(regions = open_regions, annotation = gene.ranges,
                                sep = c(':', '-'))
write.csv(closest_genes, file='./signac_analysis/scrublet_test/human_scatac_adult_0520.harmony.marker_gene_ids.res0.4.csv')
...
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0520.harmony.known_marker.dotplot.res0.4.pdf", width = 20)
...
dev.copy2pdf(file="./signac_analysis/scrublet_test/human_scatac_adult_0520.harmony_res0.4.UMAP_celltypes.pdf", width=20)
...
write.csv(cell.info, file='./signac_analysis/scrublet_test/human_scatac_adult_0520.harmony.res0.4.cellinfo.csv')

##get counts per sample/cell class
sample.celltype.info = table(hm.integrated$celltype, hm.integrated$dataset)
write.csv(sample.celltype.info, file='./signac_analysis/scrublet_test/human_scatac_adult_0520.harmony.res0.4.sample_cell_info.csv')

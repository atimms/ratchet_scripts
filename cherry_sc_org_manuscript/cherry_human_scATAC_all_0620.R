...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d53.qc.pdf", width=20)
FragmentHistogram(object = d53, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d53.frag_by_ns.pdf", width=20)
TSSPlot(d53, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d53.tss_enrichment.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d53.UMAP.pdf", width=20)

##d59
VlnPlot(object = d59, features = c('pct_reads_in_peaks', 'blacklist_ratio', 'nucleosome_signal', 'peak_region_fragments'),pt.size = 0.1,ncol = 4) + NoLegend()
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d59.qc.pdf", width=20)
FragmentHistogram(object = d59, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d59.frag_by_ns.pdf", width=20)
TSSPlot(d59, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d59.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
d59_subset <- subset(d59, subset = peak_region_fragments > 2000 & peak_region_fragments < 30000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
d59
d59_subset
##Normalization and linear dimensional reduction
d59_subset <- RunTFIDF(d59_subset)
d59_subset <- FindTopFeatures(d59_subset, min.cutoff = 'q0')
d59_subset <- RunSVD(object = d59_subset, assay = 'ATAC',
                     reduction.key = 'LSI_', reduction.name = 'lsi')
##correlation between depth and dims (may need to remove dim1 from analysis)
DepthCor(d59_subset)
##Non-linear dimension reduction and clustering
d59_subset <- RunUMAP(object = d59_subset, reduction = 'lsi', dims = 2:30)
d59_subset <- FindNeighbors(object = d59_subset, reduction = 'lsi', dims = 2:30)
d59_subset <- FindClusters(object = d59_subset, verbose = FALSE, algorithm = 3)
DimPlot(object = d59_subset, label = TRUE) + NoLegend()
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d59.UMAP.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d74.qc.pdf", width=20)
FragmentHistogram(object = d74, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d74.frag_by_ns.pdf", width=20)
TSSPlot(d74, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d74.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d74.UMAP.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d78.qc.pdf", width=20)
FragmentHistogram(object = d78, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d78.frag_by_ns.pdf", width=20)
TSSPlot(d78, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d78.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d78.UMAP.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d113.qc.pdf", width=20)
FragmentHistogram(object = d113, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d113.frag_by_ns.pdf", width=20)
TSSPlot(d113, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d113.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d113.UMAP.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d132.qc.pdf", width=20)
FragmentHistogram(object = d132, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d132.frag_by_ns.pdf", width=20)
TSSPlot(d132, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d132.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.d132.UMAP.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu5.qc.pdf", width=20)
FragmentHistogram(object = Hu5, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu5.frag_by_ns.pdf", width=20)
TSSPlot(Hu5, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu5.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu5.UMAP.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu7.qc.pdf", width=20)
FragmentHistogram(object = Hu7, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu7.frag_by_ns.pdf", width=20)
TSSPlot(Hu7, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu7.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu7.UMAP.pdf", width=20)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu8.qc.pdf", width=20)
FragmentHistogram(object = Hu8, group.by = 'nucleosome_group')
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu8.frag_by_ns.pdf", width=20)
TSSPlot(Hu8, group.by = 'high.tss') + ggtitle("TSS enrichment score") + NoLegend()
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu8.tss_enrichment.pdf", width=20)
##filter using qc metrics
#pbmc <- subset(pbmc, subset = peak_region_fragments > 3000 & peak_region_fragments < 20000 & pct_reads_in_peaks > 15 & blacklist_ratio < 0.05 & nucleosome_signal < 10 & TSS.enrichment > 2)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0620.Hu8.UMAP.pdf", width=20)


##merge data
## create a common peak set
combined.peaks <- UnifyPeaks(object.list = list(d53_subset,d59_subset,d74_subset,d78_subset,d113_subset,d132_subset,Hu5_subset,Hu7_subset,Hu8_subset), mode = "reduce")
combined.peaks
...
d59.counts <- FeatureMatrix(fragments = GetFragments(d59_subset), features = combined.peaks,
                            sep = c(":", "-"), cells = colnames(d59_subset))
d59_subset[['peaks']] <- CreateAssayObject(counts = d59.counts)
...
combined <- merge(x = d53_subset, y = list(d59_subset,d74_subset,d78_subset,d113_subset,d132_subset,Hu5_subset,Hu7_subset,Hu8_subset), add.cell.ids = c("d53", "d59","d74", "d78","d113", "d132", "Hu5", "Hu7", "Hu8"))
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0520.merged.res_0.4.UMAP_by_cluster.pdf", width=20)
DimPlot(combined, split.by = 'dataset', pt.size = 0.1, label = TRUE)
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0520.merged.res_0.4.UMAP_split_by_sample.pdf", width=20)

##merged fragments using unix commands, so add to merged object
combined <- SetFragments(combined, "/active/cherry_t/OrgManuscript_SingleCell_Data/human_scATAC/merge_fragments_all/fragments.tsv.gz")

# save combined object
saveRDS(combined, file = "./signac_analysis/all/combined.rds")
saveRDS(combined.peaks, file = "./signac_analysis/all/combined_peaks.rds")

##delete old objects
rm(d53_subset,d59_subset,d74_subset,d78_subset,d113_subset,d132_subset,Hu5_subset,Hu7_subset,Hu8_subset,d53, d59,d74, d78,d113, d132, Hu5, Hu7, Hu8)

##load file if needed
#combined <- readRDS(file = "./signac_analysis/all/combined.rds")
...
write.csv(combined.markers, file='./signac_analysis/all/human_scatac_all_0520.merged.markers.csv')
...
closest_genes <- ClosestFeature(regions = open_regions, annotation = gene.ranges,
                                sep = c(':', '-'))
write.csv(closest_genes, file='./signac_analysis/all/human_scatac_all_0520.merged.marker_gene_ids.csv')
...
fragment.path = "/active/cherry_t/OrgManuscript_SingleCell_Data/human_scATAC/merge_fragments_all/fragments.tsv.gz"
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0520.merged.known_marker.dotplot.res0.4.pdf", width = 20)
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0520.harmony_res0.4.UMAP_by_cluster.pdf", width=20)
DimPlot(hm.integrated, split.by = 'dataset', pt.size = 0.1, label = TRUE)
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0520.harmony_res0.4.UMAP_split_by_sample.pdf", width=20)

##save/load file
saveRDS(hm.integrated, file = "./signac_analysis/all/harmony_integrated.rds")
#hm.integrated <- readRDS(file = "./signac_analysis/all/harmony_integrated.rds")
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0520.harmony.feature_plot1.res0.4.pdf", width=20)
...
write.csv(harmony.markers, file='./signac_analysis/all/human_scatac_all_0520.harmony.marker.res0.4.csv')
head(harmony.markers)

## get genes closest to marker genes, row names are weird in a few places
##temp way to lead results
#harmony.markers <- read.csv('./signac_analysis/all/human_scatac_all_0520.harmony.marker.res0.4.csv')
##list of peaks
...
closest_genes <- ClosestFeature(regions = open_regions, annotation = gene.ranges,
                                sep = c(':', '-'))
write.csv(closest_genes, file='./signac_analysis/all/human_scatac_all_0520.harmony.marker_gene_ids.res0.4.csv')
...
dev.copy2pdf(file="./signac_analysis/all/human_scatac_all_0520.harmony.known_marker.dotplot.res0.4.pdf", width = 20)

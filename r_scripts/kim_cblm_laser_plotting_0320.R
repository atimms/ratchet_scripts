...
setwd('/data/atimms/kim_laser_graphing_0320')
...
k6_r5_hgdp <- read.csv('exomes_0320.k6_r5.hgdp_all.txt', sep ='\t')
k10_r5_hgdp <- read.csv('exomes_0320.k10_r5.hgdp_all.txt', sep ='\t')
k10_r10_hgdp <- read.csv('exomes_0320.k10_r10.hgdp_all.txt', sep ='\t')
...
ggsave('exomes_0320.k6_r5.pc1_pc2.pdf')
...
ggsave('exomes_0320.k6_r5.pc3_pc4.pdf')
...
ggsave('exomes_0320.k10_r10.pc1_pc2.pdf')
...
ggsave('exomes_0320.k10_r10.pc3_pc4.pdf')
...
ggsave('exomes_0320.k10_r10.pc5_pc6.pdf')
...
ggsave('exomes_0320.k10_r10.pc7_pc8.pdf')